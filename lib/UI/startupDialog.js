            ...
            <div class="${this.contentClass}" style="display:grid;grid-template-columns:2fr 3fr;align-items:center;">
                ...
                <div class="${this.messageContainerClass}">
                    ...
                    <div class="startupWelcome" style="display:none;">
                            <h2>Welcome to noice.js</h2>
                        <p>To begin, touch "start"</p>
                    </div>
...
setup(){
    ...
    */
    ...
    ['netStatus','dbStatus','title', 'message', 'netReadBytes', 'showPieChart', 'showCancelBtn', 'welcomeMode'].forEach(function(at){ this[at] = this[at]; }, this);
