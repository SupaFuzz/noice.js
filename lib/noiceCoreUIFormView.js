...
get html(){
    ...
    return(`
        ...
        <div class="${this._className}Fields" style="display:grid;grid:1fr;text-align:center;">
            <div class="fvCtrlPnl">${this.fieldReference('saveButton')}</div>
...
clickSaveButton(evt){
    ...
    /*
        ...
        this means next steps:
            ...
            1) set up a test harness to set the different form modes
               make sure that shit works

            2) go back into setup() and set the default form mode, etc

            3) test triggering the dirtyRecordAreYouSure() with a form mode change
