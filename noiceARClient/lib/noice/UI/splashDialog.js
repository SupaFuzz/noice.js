...
get html(){return(`
    <div class="startupDialogUI">
        ...
        <div class="${this.contentClass}" style="display:grid;grid-template-columns:2fr 3fr;align-items:center;">
            ...
            <div data-templatename="messageContainer" class="${this.messageContainerClass}" style="height: 90%;"></div>
        </div>
    </div>
`)}
...
/*
    ...
    override this getter to change it
*/
get welcomeImage(){ return(this.hicox_flower); }
get hicox_flower(){
