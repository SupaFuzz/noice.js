    ...
    if (this.hasAttribute('valueChangeCallback') && (this.valueChangeCallback instanceof Function)){
        ...
        /*
            ...
            this still doesn't work.
                focus the field and enter a value
                go back and null it out
                the change flag never resets because we never got the signal
                that the value was reset to null.

                this infuriating ... starting to think this whole shit needs a rewrite

                this line kinda works
                if (!((this.labelLocation == 'embed') && ((this.isNull(vt)) || (vt == this.label)))){
        */
...
setup(){
    ...
    ['minLength', 'maxLength', 'readonly', 'size', 'spellcheck', 'autocorrect', 'required', 'labelLocation'].forEach(function(att){
