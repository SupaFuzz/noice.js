...
/*
    override the value getter so we don't return the embedded label as a value
    this breaks embed label?
get value(){
    if (this.formElement instanceof Element){
        return(((this.labelLocation == 'embed') && (this.formElement.value == this.label))?null:this.formElement.value);
    }else{
        return(((this.labelLocation == 'embed') && (this.formElement.value == this.label))?null:this._value);
    }
}
set value(v){ super.value}
*/
